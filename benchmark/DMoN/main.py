...
def main():
    parser = argparse.ArgumentParser(description='DMoN for node clustering')
    ...
    # DMoN does not support mini-batch training
    if conf.get('mini_batch', False):
        logger.warning("DMoN does not support mini-batch training. Setting mini_batch=False.")
