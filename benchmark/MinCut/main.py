...
from pyagc.models import MinCut
...
def main():
    parser = argparse.ArgumentParser(description='MinCut for node clustering')
    ...
    # MinCut does not support mini-batch training
    if conf.get('mini_batch', False):
        logger.warning("MinCut does not support mini-batch training. Setting mini_batch=False.")
